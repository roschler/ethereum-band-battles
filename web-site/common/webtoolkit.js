/**
 * Some routines taken from the open source WebToolkit project

	This javascript code is used to encode / decode data using base64 (this encoding
		is designed to make binary data survive transport through transport layers
		that are not 8-bit clean). Script is fully compatible with UTF-8 encoding.
	...
	License
		...
		back to this website, you can use any of the content published on this website
		free of charge for any use: commercial or noncommercial. However, under the
		license they are released through there are limitations to what you may or
		may not do.
		...
		You can NOT copy the full webpage and display it on your own website.
			(Use an excerpt by all means, but please link to the original
			resource download page – not the actual file.)
 */
...
// Adding objects to the global namespaces is a usually a bad idea, but if we don't,
//  The stock jsoncomp package will error out because Base64 is not defined.
global.gzip = require('gzip-js');
